    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Does list contain Pistachio Ice Cream? " 
                + sl.contains(new Grocery("Pistachio Ice Cream",
                  "Dairy", 10, 2.99f, 1)));
            System.out.println("Does list contain Dill Pickles? "
                + sl.contains(new Grocery("Dill Pickles",
                    "Condiments", 4, 2.99f, 1)));
            System.out.println("Let's add 3 jars of pickles.");
            sl.add(new Grocery("Dill Pickles", 
                "Condiments", 4, 2.99f, 3));
            // remove ice cream
            System.out.println("Let's remove the ice cream.");
            sl.remove(new Grocery("Pistachio Ice Cream",
                "Dairy", 10, 2.99f, 1));
            System.out.println("Does list contain Pistachio Ice Cream? "
                + sl.contains(new Grocery("Pistachio Ice Cream", 
                   "Dairy", 10, 2.99f, 1)));
