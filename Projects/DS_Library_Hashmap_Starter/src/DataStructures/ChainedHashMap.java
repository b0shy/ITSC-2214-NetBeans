...
public class ChainedHashMap<K, V> {
     ...
     *
     * @return true empty map false not empty map
     */
    ...
    /**
     * TODO Identify the bucket index for the given key, in which the key-value
     * pair can be searched for or found or insertion or deletion
     *
     * @param key a key
     * @return index of array element where key-value pair can be found
     */
     ...
     *
     * @param key a key
     * @return value of array element where key-value pair can be found
     */
    ...
    /**
     * TODO Adds a key value pair to hash To avoid having many buckets with
     * multiple values, the capacity is doubled if 70% (the load factor) of the
     * buckets become non-empty. The default value for the load factor is 70%,
     * and the default initial capacity is 16.
     *
